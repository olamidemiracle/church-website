...
const NAV_SECTIONS = [
  ...
  },
  {
    heading: 'Content',
    items: [
      { label: 'Manage Sermons', path: '/admin/sermons', enabled: false },
      { label: 'Manage Events', path: '/admin/events', enabled: false },
      { label: 'Manage Ministries', path: '/admin/ministries', enabled: false },
      { label: 'Manage Gallery', path: '/admin/gallery', enabled: false },
      { label: 'Manage Leadership', path: '/admin/leadership', enabled: false },
      { label: 'Manage Announcements', path: '/admin/news', enabled: false },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Testimonies', path: '/admin/testimonies', enabled: false },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Website Settings', path: '/admin/settings', enabled: false, superadminOnly: true },
